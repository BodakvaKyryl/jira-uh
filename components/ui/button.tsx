...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive border-input inline-flex shrink-0 items-center justify-center gap-2 rounded-md border text-sm font-semibold whitespace-nowrap shadow-sm transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-300 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "text-primary-foreground border bg-gradient-to-b from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-700",
        destructive:
        ...
        teritary: "border-transparent bg-blue-100 text-blue-600 shadow-none hover:bg-blue-200",
      },
      size: {
